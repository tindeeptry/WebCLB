    ...
    <div class="container">
        ...
        <form action="giaovien" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="TenGV" name="TenGV" value="<%= teacher != null ? teacher.getTenGV() : "" %>" required>
            </div>

            <div class="form-group">
                <label for="SDT">Số điện thoại</label>
                <input type="tel" class="form-control" id="SDT" name="SDT" value="<%= teacher != null ? teacher.getSDT() : "" %>">
            </div>

            <div class="form-group">
                <label for="email">Email</label>
                <input type="email" class="form-control" id="email" name="email" value="<%= teacher != null ? teacher.getEmail() : "" %>" required>
            </div>

            <div class="form-group">
                <label for="DOB">Ngày sinh</label>
                <input type="date" class="form-control" id="DOB" name="DOB" value="<%= teacher != null ? teacher.getDOB() : "" %>">
            </div>
